...
import com.example.pchart.Utility.FilePaths;
...
public class ProfileActivity extends AppCompatActivity implements
    ...
    public void uploadNewPhoto(Uri imageUri) {
        ...
        //Only accept image sizes that are compressed to under 5MB. If that is not possible
    ...
    public class BackgroundImageResize extends AsyncTask<Uri, Integer, byte[]> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            showDialog();
            Toast.makeText(ProfileActivity.this, "compressing image", Toast.LENGTH_SHORT).show();
        }
        ...
        protected byte[] doInBackground(Uri... params) {
            ...
            if (mBitmap == null) {
                ...
                try {
                    mBitmap = MediaStore.Images.Media.getBitmap(ProfileActivity.this.getContentResolver(), params[0]);
        ...
        if (mBytes.length / MB < MB_THRESHHOLD) {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(ProfileActivity.this, "could not upload photo", Toast.LENGTH_SHORT).show();
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (currentProgress > (progress + 15)) {
                        ...
                        Toast.makeText(ProfileActivity.this, progress + "%", Toast.LENGTH_SHORT).show();
                    }
